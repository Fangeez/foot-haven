...
struct MockPreviews {
    ...
    static let teamStatNumbers: [Int] = [19, 9, 5, 5]
    static let leagueStandings: [String] = ["Manchester City", "Liverpool", "Chelsea", "Arsenal", "Manchester United", "Tottenham Hotspur"]
    static let leaguePoints: [Int] = [87, 85, 72, 67, 60, 59]
